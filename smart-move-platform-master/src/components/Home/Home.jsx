        ...
        <section className="Home">
            ...
            <section className="about">
                <div className="container">
                    ...
                    <p>Collaborate with multidisciplinary teams of students/researchers and co-create data-powered sustainable digital solutions to reimagine they way we commute through our India cities. </p>
            ...
            <section className="unlock container">
                ...
                <p className="align-left">Calling all students and researchers from India and around the world! Put on your thinking caps, ideate, innovate and share with us a brief concept note on any of the following themes. </p>
